META:TOPICINFO{author="ajurj" date="1497296021" format="1.1"
reprev="1.2" version="1.2"}
META:TOPICPARENT{name="IoTContinuousEngineeringSolution604"}

# Installing the Internet of Things Continuous Engineering Solution from the launchpad DKGRAY Authors: Main.AndreeaJurj Build basis: Version 6.0.4 [installing-the-internet-of-things-continuous-engineering-solution-from-the-launchpad-dkgray-authors-main.andreeajurj-build-basis-version-6.0.4]
...
with configuration
management](http://www-01.ibm.com/support/knowledgecenter/SSYMRC_6.0.4/com.ibm.jazz.vvc.doc/topics/c_cm_assess.html).
...
1.  Download the IoT Continuous Engineering Solution web installer for
    ...
    [Jazz.net](https://jazz.net/downloads/continuous-engineering-solution/releases/6.0.4?p=allDownloads). 2.
...
CLM](http://www.ibm.com/support/knowledgecenter/SSYMRC_6.0.4/com.ibm.jazz.install.doc/topics/c_planning_install.html).
...
documentation](https://www.ibm.com/support/knowledgecenter/SSYMRC_6.0.4/com.ibm.jazz.install.doc/topics/c_jsasso_jas_user_management.html).
...
-   [Installing the Money that Matters
    sample](http://www.ibm.com/support/knowledgecenter/SSYMRC_6.0.4/com.ibm.jazz.install.doc/topics/t_install_sample_project.html)
-   [Configuring the Money that Matters sample
    environment](http://www.ibm.com/support/knowledgecenter/SSYMRC_6.0.4/com.ibm.jazz.install.doc/topics/t_config_sample_proj.html)
...
documentation](http://www-01.ibm.com/support/knowledgecenter/SSYMRC_6.0.4/com.ibm.jazz.install.doc/topics/t_sample_project.html).

##### Related topics: \* [Installation overview](IoTContinuousEngineeringSolutionInstallationRoadmap604) [related-topics-installation-overview]
