META:TOPICINFO{author="ajurj" date="1496067508" format="1.1"
version="1.2"}
META:TOPICPARENT{name="DeploymentInstallingUpgradingAndMigrating"}

# Installing the IBM Internet of Things Continuous Engineering Solution DKGRAY Authors: Main.AndreeaJurj Build basis: Version 6.0.4 [installing-the-ibm-internet-of-things-continuous-engineering-solution-dkgray-authors-main.andreeajurj-build-basis-version-6.0.4]
...
IBM DOORS Next Generation v6.0.4
...
IBM Rational DOORS Web Access v9.6.1.9
...
IBM Rational Rhapsody Design Manager v6.0.4
...
IBM Rational Team Concert v6.0.4
...
IBM Rational Quality Manager v6.0.4
...
IBM Rational Jazz Reporting Service v6.0.4
...
IBM Rational Global Configuration Management v6.0.4
...
IBM Rational Link Index Provider v6.0.4
...
IBM Rational Engineering Lifecycle Manager v6.0.4
...
[Uninstalling
software](http://www-01.ibm.com/support/knowledgecenter/SSYMRC_6.0.4/com.ibm.jazz.install.doc/topics/t_uninstall_product_jts.html)

##### Related topics: [Upgrading the IoT Continuous Engineering Solution](IoTContinuousEngineeringSolutionUpgrading604) [related-topics-upgrading-the-iot-continuous-engineering-solution]

##### External links: [external-links]

-   [Introduction to the Internet of Things Continuous Engineering
    Solution](http://www.ibm.com/support/knowledgecenter/SSYMRC_6.0.4/com.ibm.help.common.jazz.calm.doc/topics/c_sse_over.html)
