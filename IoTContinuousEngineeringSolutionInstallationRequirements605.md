META:TOPICINFO{author="ajurj" date="1510693548" format="1.1"
version="1.2"}
...
Build basis: Version 6.0.5 ENDCOLOR
...
-   [System requirements for the Internet of Things (IoT) Continuous
    Engineering Solution](SSESystemRequirements605)
...
-   [Support
    ...
    updates.
-   [Maximizing
    performance](http://www.ibm.com/support/knowledgecenter/SSYMRC_6.0.5/com.ibm.jazz.install.doc/topics/t_max_perf.html):
...
-   [Deployment and installation planning for the Rational solution for
    CLM](https://www.ibm.com/support/knowledgecenter/SSYMRC_6.0.5/com.ibm.jazz.install.doc/topics/c_planning_install.html)
-   [Downloading the installation
    media](https://www.ibm.com/support/knowledgecenter/SSYMRC_6.0.5/com.ibm.jazz.install.doc/topics/t_download_clm.html)
...
-   [Release notes for Rational
    Rhapsody](http://www.ibm.com/support/knowledgecenter/SSB2MU_8.3.0/com.ibm.rhp.installing.doc/topics/rhp_r_iu_release_notes_rhp_751.html)
-   [Planning to install Rational
    Rhapsody](http://www.ibm.com/support/knowledgecenter/SSB2MU_8.3.0/com.ibm.rhp.installing.doc/topics/rhp_c_iu_planning_installation.html)
-   [Rational Rhapsody - Preinstallation
    tasks](http://www.ibm.com/support/knowledgecenter/SSB2MU_8.3.0/com.ibm.rhp.installing.doc/topics/rhp_c_iu_preinstallation_tasks.html)

##### Related topics: \* [Installing from the launchpad](IoTContinuousEngineeringSolutionInstallWizard605) [related-topics-installing-from-the-launchpad]
...
-   [IoT Continuous Engineering Solution Release
    Notes](https://jazz.net/downloads/continuous-engineering-solution/releases/6.0.5?p=releaseNotes)
