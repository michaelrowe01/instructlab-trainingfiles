META:TOPICINFO{author="ajurj" date="1450123699" format="1.1"
version="1.8"} META:TOPICPARENT{name="IoTContinuousEngineeringSolution"}

# IBM Internet of Things Continuous Engineering Solution - Installation overview DKGRAY Authors: Main.AndreeaJurj Build basis: Version 6.0.1 [ibm-internet-of-things-continuous-engineering-solution---installation-overview-dkgray-authors-main.andreeajurj-build-basis-version-6.0.1]
...
documentation](https://www.ibm.com/support/knowledgecenter/SSYMRC_6.0.1/com.ibm.jazz.install.doc/topics/c_install_overview.html):
...
applications](https://www.ibm.com/support/knowledgecenter/SSYMRC_6.0.1/com.ibm.rcam.linking.doc/topics/c_node_integrating.html).
\* Learn about [integrating Rational Rhapsody with other development
lifecycle management
applications](http://www.ibm.com/support/knowledgecenter/SSB2MU_8.1.4/com.ibm.rhp.nav.doc/topics/c_node_integrating.html).
...
##### Related topics: \* [Installing the IoT Continuous Engineering Solution from the launchpad](IoTContinuousEngineeringSolutionInstallWizard) [related-topics-installing-the-iot-continuous-engineering-solution-from-the-launchpad]

-   [Installing the required applications for the
    solution](IoTContinuousEngineeringSolutionInstallingApplications)

##### External links: [external-links]

-   [Introduction to the Internet of Things Continuous Engineering
    Solution](https://www-01preview.ibm.com/support/knowledgecenter/SSYMRC_6.0.1/com.ibm.help.common.jazz.calm.doc/topics/c_sse_over.html)
